"""
Ce script permet d'effectuer un "apprentissage" sur le corpus en construisant des patrons lexico-syntaxiques.
C'est une idée qui nous semblait bonne lorsqu'on l'a conceptualisé mais qui au final n'a pas donné de résultats viables.
